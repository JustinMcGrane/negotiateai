...
const benefits = [
  { icon: Map, title: 'Stage-by-stage strategy', desc: 'Know exactly what to do from the moment you get the offer through final sign-off — nothing left to chance.' },
  { icon: Layers, title: 'Built for your situation', desc: 'Your playbook is tailored to your role, company type, leverage, and goals — not a generic checklist.' },
  { icon: BookOpen, title: 'Everything in one place', desc: 'Scripts, timing, priorities, and fallback positions — all organized so you can execute without scrambling.' },
]

const steps = [
  { number: '01', title: 'Tell us about your situation', desc: 'Share where you are in the process, what you have in hand, and what you\'re trying to get.' },
  { number: '02', title: 'Get your custom playbook', desc: 'Receive a tailored negotiation strategy with stage-by-stage actions and decision points.' },
  { number: '03', title: 'Execute with confidence', desc: 'Follow the playbook through the process — knowing what to do next at every step.' },
]
    ...
    <div style={{ background: '#fff', minHeight: '100vh' }}>
      ...
      <section style={{ maxWidth: 900, margin: '0 auto', padding: '56px 24px 72px', textAlign: 'center' }}>
        <h1 style={{ fontSize: 'clamp(36px, 6.5vw, 76px)', fontWeight: 800, lineHeight: 1.12, letterSpacing: '-0.03em', marginBottom: 24, color: '#0f172a', whiteSpace: 'nowrap' }}>
          Your complete strategy,<br /><span style={{ color: '#4169E1' }}>start to finish.</span>
        </h1>
        <p style={{ fontSize: 18, color: '#475569', lineHeight: 1.7, maxWidth: 560, margin: '0 auto 40px' }}>
          Get a step-by-step negotiation playbook built for your exact situation — so you know what to do at every stage of the offer process.
        </p>
        ...
        <div style={{ display: 'flex', gap: 24, justifyContent: 'center', flexWrap: 'wrap' }}>
          {['Tailored to your situation', 'Stage-by-stage actions', 'Free to use'].map(t => (
      ...
      <section style={{ background: '#f8fafc', borderTop: '0.5px solid #e5e7eb', borderBottom: '0.5px solid #e5e7eb', padding: '72px 24px' }}>
        <div style={{ maxWidth: 960, margin: '0 auto' }}>
          <h2 style={{ fontSize: 'clamp(22px, 3.5vw, 34px)', fontWeight: 800, letterSpacing: '-0.02em', color: '#0f172a', textAlign: 'center', marginBottom: 12 }}>Winging it is how you leave money behind.</h2>
          <p style={{ fontSize: 16, color: '#64748b', textAlign: 'center', maxWidth: 520, margin: '0 auto 56px' }}>The best negotiators don&apos;t wing it. They follow a plan they built before the call.</p>
      ...
      <section style={{ background: '#0f172a', padding: '72px 24px', textAlign: 'center' }}>
        <h2 style={{ fontSize: 'clamp(24px, 4vw, 38px)', fontWeight: 800, color: '#fff', letterSpacing: '-0.02em', marginBottom: 16 }}>Go into your negotiation with a plan.</h2>
        <p style={{ fontSize: 16, color: '#94a3b8', maxWidth: 480, margin: '0 auto 36px' }}>Get your custom playbook in minutes — free, no credit card required.</p>
