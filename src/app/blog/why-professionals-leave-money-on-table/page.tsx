  ...
  return (
    <article>
      ...
      <div style={{ fontSize: 16, lineHeight: 1.85, color: '#334155' }}>
        ...
        <p style={{ marginBottom: 24 }}>Use Hayven&apos;s <Link href="/raise-calculator" style={{ color: '#4169E1', textDecoration: 'none', fontWeight: 600 }}>Cost of Not Negotiating calculator</Link> to see the exact dollar amount you&apos;re leaving behind over 5, 10, and 20 years based on your current salary gap.</p>
