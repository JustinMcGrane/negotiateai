  ...
  return (
    <article>
      ...
      <div style={{ fontSize: 16, lineHeight: 1.85, color: '#334155' }}>
        ...
        <p style={{ marginBottom: 24 }}>Hayven&apos;s <Link href="/compensation-analyzer" style={{ color: '#4169E1', textDecoration: 'none', fontWeight: 600 }}>Compensation Analyzer</Link> gives you a precise market rate based on your specific role, level, and city — so you go into any negotiation with real data, not a guess.</p>
        ...
        <p style={{ marginBottom: 24 }}>If you want to practice handling pushback before the real conversation, Hayven&apos;s <Link href="/negotiation-simulator" style={{ color: '#4169E1', textDecoration: 'none', fontWeight: 600 }}>Negotiation Simulator</Link> lets you roleplay the entire negotiation and get scored feedback.</p>
        ...
        <p style={{ marginBottom: 24 }}>The solution is practice. Run the conversation before it happens. The more familiar it feels, the more confident you&apos;ll be when it matters. Use Hayven&apos;s <Link href="/negotiation-simulator" style={{ color: '#4169E1', textDecoration: 'none', fontWeight: 600 }}>Negotiation Simulator</Link> to practice against a realistic AI coach and get scored feedback before your next real negotiation.</p>
      </div>
