  ...
  return (
    <article>
      ...
      <div style={{ fontSize: 16, lineHeight: 1.85, color: '#334155' }}>
        ...
        <p style={{ marginBottom: 24 }}>For the full playbook on negotiating after an offer — including what to say and when — read <Link href="/blog/how-to-negotiate-salary-after-job-offer" style={{ color: '#4169E1', textDecoration: 'none', fontWeight: 600 }}>how to negotiate salary after a job offer</Link>. And if you want a ready-to-send email, Hayven&apos;s <Link href="/counter-offer-builder" style={{ color: '#4169E1', textDecoration: 'none', fontWeight: 600 }}>Counter-Offer Builder</Link> generates a personalized script based on your specific situation.</p>
      </div>
