  ...
  return (
    <article>
      ...
      <div style={{ fontSize: 16, lineHeight: 1.85, color: '#334155' }}>
        ...
        <p style={{ marginBottom: 24 }}>Before you send anything, make sure you have a number backed by market data. Hayven&apos;s <Link href="/compensation-analyzer" style={{ color: '#4169E1', textDecoration: 'none', fontWeight: 600 }}>Compensation Analyzer</Link> gives you your precise market rate so your counter is grounded in evidence. And if you want a full walkthrough of the negotiation process before you put words on paper, read <Link href="/blog/how-to-negotiate-salary-after-job-offer" style={{ color: '#4169E1', textDecoration: 'none', fontWeight: 600 }}>how to negotiate salary after a job offer</Link>.</p>
      </div>
