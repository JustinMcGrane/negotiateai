  ...
  return (
    <article>
      ...
      <div style={{ marginTop: 64, background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: 16, padding: '32px 28px' }}>
        ...
        <div style={{ fontSize: 15, color: '#64748b', marginBottom: 24, lineHeight: 1.65 }}>Use Hayven&apos;s simulator to practice with a realistic AI coach. Get a scored debrief and specific feedback.</div>
