...
const articleSchema = {
  ...
  '@type': 'Article',
  headline: 'The 5 Recruiter Types and How to Handle Each',
  description: 'The 5 recruiter archetypes and the exact strategy for each.',
  url: 'https://gethayven.com/blog/recruiter-types-and-how-to-handle',
  ...
  return (
    <article>
      ...
      <div style={{ fontSize: 16, lineHeight: 1.85, color: '#334155' }}>
        ...
        <p style={{ marginBottom: 24 }}>Use Hayven&apos;s <Link href="/offer-evaluator" style={{ color: '#4169E1', textDecoration: 'none', fontWeight: 600 }}>Offer Evaluator</Link> to score the full package — not just base — so you know whether the total comp actually meets your needs before pushing back.</p>
