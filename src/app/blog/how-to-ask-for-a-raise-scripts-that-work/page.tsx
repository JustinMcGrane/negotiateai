  ...
  return (
    <article>
      ...
      <div style={{ fontSize: 16, lineHeight: 1.85, color: '#334155' }}>
        ...
        <p style={{ marginBottom: 24 }}>Most people dramatically underestimate how much they leave on the table over a career by avoiding this conversation. Even a single successful ask early in your career can be worth $100,000+ in lifetime earnings. Use Hayven&apos;s <Link href="/raise-calculator" style={{ color: '#4169E1', textDecoration: 'none', fontWeight: 600 }}>Cost of Not Negotiating calculator</Link> to see the compounding dollar impact over your career.</p>
        <p style={{ marginBottom: 24 }}>If you want a fully built raise request — with your wins, market data, and talking points organized — Hayven&apos;s <Link href="/raise-request-builder" style={{ color: '#4169E1', textDecoration: 'none', fontWeight: 600 }}>Raise Builder</Link> generates a complete raise case in minutes.</p>
      </div>
