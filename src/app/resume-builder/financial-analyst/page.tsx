...
export const metadata: Metadata = {
  title: 'Financial Analyst Resume — AI Builder & Templates | Hayven',
  description: 'Build a financial analyst resume that gets interviews. AI-powered ATS scoring, bullet rewrites, and finance-specific keyword analysis. Free to start.',
  alternates: { canonical: 'https://gethayven.com/resume-builder/financial-analyst' },
  openGraph: { title: 'Financial Analyst Resume Builder | Hayven', description: 'AI resume builder for financial analysts. ATS scoring, bullet rewrites, and finance templates.' },
}

const bullets = {
  before: 'Built financial models and helped leadership understand the company\'s financial position.',
  after: 'Built a 3-statement LBO model and DCF analysis for a $47M acquisition target — surfacing a 2.1x valuation gap that informed the final bid price and contributed to a $4.2M cost reduction in the deal structure.',
}

const tips = [
  { title: 'Model complexity signals your level', desc: 'DCF, LBO, 3-statement, scenario analysis, sensitivity tables — name the models you\'ve built. A vague "financial model" tells hiring managers nothing about your technical depth.' },
  { title: 'Dollar size of analysis matters', desc: 'Always include the dollar magnitude of what you analyzed. Evaluating a $5M OpEx line and a $500M capital allocation decision are not the same job.' },
  { title: 'Variance analysis is underrated on resumes', desc: 'If you ran monthly budget vs. actuals, identified root causes of variances, and communicated findings to leadership — that\'s a core FP&A skill. Be explicit about who you presented to.' },
  { title: 'Tools and software are table stakes', desc: 'Excel (advanced), Power BI, Tableau, SQL, Python, Bloomberg, FactSet, SAP — ATS systems filter for these. Name the tools you use fluently in a dedicated Skills section.' },
  { title: 'Forecasting accuracy is a metric', desc: 'If your forecasts had a measurable accuracy rate, say so. "Maintained rolling 12-month forecast with <3% variance to actuals for 6 consecutive quarters" is a standout resume bullet.' },
  { title: 'Industry context closes deals', desc: 'FP&A at a SaaS company, corporate finance at a bank, and VC financial modeling are all different. Name your industry and the business model you\'ve worked in — it\'s a filter recruiters use constantly.' },
]

const keywords = ['Financial Modeling', 'DCF', 'LBO', 'FP&A', 'Excel', 'SQL', 'Variance Analysis', 'Budget Management', 'Forecasting', 'Power BI', 'Tableau', 'Bloomberg', 'FactSet', 'Valuation', 'M&A']

export default function FinancialAnalystResumePage() {
  return (
    <div style={{ background: '#fff', minHeight: '100vh' }}>
      ...
      <section style={{ maxWidth: 860, margin: '0 auto', padding: '56px 24px 64px', textAlign: 'center' }}>
        <div style={{ display: 'inline-block', fontSize: 12, fontWeight: 700, color: '#4169E1', background: '#eff6ff', padding: '4px 14px', borderRadius: 20, marginBottom: 20, letterSpacing: '0.06em' }}>FINANCIAL ANALYST RESUME</div>
        <h1 style={{ fontSize: 'clamp(32px, 5vw, 58px)', fontWeight: 800, lineHeight: 1.1, letterSpacing: '-0.03em', marginBottom: 20, color: '#0f172a' }}>
          A financial analyst resume<br />that shows the depth of your work
        </h1>
        <p style={{ fontSize: 17, color: '#475569', lineHeight: 1.75, maxWidth: 560, margin: '0 auto 36px' }}>
          Get ATS scoring, finance-specific bullet rewrites, and keyword gap analysis for your target role — in under 60 seconds. Free to start.
        </p>
      ...
      <section style={{ background: '#f8fafc', borderTop: '0.5px solid #e5e7eb', borderBottom: '0.5px solid #e5e7eb', padding: '64px 24px' }}>
        <div style={{ maxWidth: 860, margin: '0 auto' }}>
          ...
          <div style={{ background: '#fff', borderRadius: 14, border: '0.5px solid #e5e7eb', overflow: 'hidden' }}>
            <div style={{ padding: '10px 24px', background: '#f8fafc', borderBottom: '0.5px solid #e5e7eb', fontSize: 11, fontWeight: 700, color: '#94a3b8', letterSpacing: '0.06em' }}>FINANCIAL ANALYST · BEFORE & AFTER</div>
      ...
      <section style={{ padding: '64px 24px' }}>
        <div style={{ maxWidth: 860, margin: '0 auto' }}>
          <h2 style={{ fontSize: 'clamp(22px, 3vw, 32px)', fontWeight: 800, letterSpacing: '-0.02em', textAlign: 'center', marginBottom: 36, color: '#0f172a' }}>Keywords ATS systems look for in finance resumes</h2>
      ...
      <section style={{ background: '#f8fafc', borderTop: '0.5px solid #e5e7eb', borderBottom: '0.5px solid #e5e7eb', padding: '64px 24px' }}>
        <div style={{ maxWidth: 960, margin: '0 auto' }}>
          <h2 style={{ fontSize: 'clamp(22px, 3vw, 32px)', fontWeight: 800, letterSpacing: '-0.02em', textAlign: 'center', marginBottom: 48, color: '#0f172a' }}>How to write a financial analyst resume</h2>
      ...
      <section style={{ background: '#0f172a', padding: '72px 24px', textAlign: 'center' }}>
        <h2 style={{ fontSize: 'clamp(24px, 4vw, 38px)', fontWeight: 800, color: '#fff', letterSpacing: '-0.02em', marginBottom: 16 }}>Get your finance resume reviewed in 60 seconds</h2>
      ...
      <section style={{ padding: '40px 24px 0', maxWidth: 860, margin: '0 auto' }}>
        <div style={{ borderTop: '0.5px solid #e5e7eb', paddingTop: 32 }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12 }}>
            <Link href="/blog/how-to-evaluate-a-job-offer" style={{ fontSize: 13, fontWeight: 600, color: '#4169E1', textDecoration: 'none', padding: '6px 14px', borderRadius: 20, background: '#eff6ff', border: '0.5px solid #bfdbfe' }}>How to Evaluate a Job Offer</Link>
            <Link href="/equity-calculator" style={{ fontSize: 13, fontWeight: 600, color: '#059669', textDecoration: 'none', padding: '6px 14px', borderRadius: 20, background: '#ecfdf5', border: '0.5px solid #a7f3d0' }}>Equity Calculator</Link>
