    ...
    <div style={{ background: '#fff', minHeight: '100vh' }}>
      ...
      <section style={{ maxWidth: 860, margin: '0 auto', padding: '96px 32px 88px', textAlign: 'center' }} className="landing-hero">
          <h1 style={{ fontWeight: 800, lineHeight: 1.1, letterSpacing: '-0.03em', marginBottom: 28, color: '#0f172a' }}>
            ...
            <span style={{ display: 'block', fontSize: 'clamp(20px, 2.4vw, 30px)', color: '#4169E1', letterSpacing: '0.01em', fontWeight: 500, marginTop: 10, fontStyle: 'italic' }}>The career companion that never clocks out.</span>
          </h1>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 24 }}>
            <div>
              ...
              <div style={{ fontSize: 17, fontWeight: 700, color: '#0f172a', marginBottom: 2 }}>Software Engineer</div>
              <div style={{ fontSize: 12, color: '#94a3b8' }}>San Francisco, CA · 4 yrs exp.</div>
            </div>
            <div style={{ background: '#fef2f2', borderRadius: 8, padding: '5px 12px', fontSize: 12, fontWeight: 700, color: '#dc2626', whiteSpace: 'nowrap' }}>
              Underpaid
            </div>
          </div>
