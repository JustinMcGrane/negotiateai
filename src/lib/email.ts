...
const FROM = 'Hayven <hello@gethayven.com>'
  ...
  return getResend().emails.send({
    ...
    html: `
      <div style="font-family: -apple-system, sans-serif; max-width: 520px; margin: 0 auto; padding: 40px 24px; color: #0f172a;">
        ...
        <a href="https://gethayven.com/recruiter?checkin=true" style="display: inline-block; background: #141414; color: #fff; padding: 12px 24px; border-radius: 9px; font-size: 14px; font-weight: 600; text-decoration: none;">
          Start your check-in →
        </a>
        <p style="font-size: 13px; color: #94a3b8; margin: 32px 0 0;">
          You are receiving this because you are a Hayven member. <a href="https://gethayven.com/settings" style="color: #94a3b8;">Manage preferences</a>
        </p>
      </div>
    `,
  })
  ...
  return getResend().emails.send({
    ...
    html: `
      <div style="font-family: -apple-system, sans-serif; max-width: 520px; margin: 0 auto; padding: 40px 24px; color: #0f172a;">
        ...
        <a href="https://gethayven.com/dashboard" style="display: inline-block; background: #141414; color: #fff; padding: 12px 24px; border-radius: 9px; font-size: 14px; font-weight: 600; text-decoration: none;">
          View your dashboard →
        </a>
        <p style="font-size: 13px; color: #94a3b8; margin: 32px 0 0;">
          You are receiving this because you have market alerts enabled. <a href="https://gethayven.com/settings" style="color: #94a3b8;">Manage preferences</a>
        </p>
      </div>
    `,
  })
